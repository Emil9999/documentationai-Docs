...
excerpt: >-
  The Kini API is designed to provide clear and actionable error messages to
  help you diagnose and resolve issues quickly. This guide outlines the common
  error codes, their meanings, and best practices for handling them.
deprecated: false
hidden: false
metadata:
  title: ''
