...
<body>
  ...
  <div class="filter-container">
    <label for="ats-select">Filter ATS:</label>
    <select id="ats-select" multiple>
      <option value="Onlyfy">Onlyfy</option>
      <option value="GuideCom">GuideCom</option>
      <option value="CustomSVG">CustomSVG</option>
      <option value="Cornerstone">Cornerstone</option>
      <option value="Workday">Workday</option>
      <option value="Zvoove">Zvoove</option>
      <option value="Softgarden (XML)">Softgarden (XML)</option>
      <option value="Softgarden (API)">Softgarden (API)</option>
      <option value="Umantis">Umantis</option>
      <option value="D.vinci">D.vinci</option>
      <option value="B-ite">B-ite</option>
      <option value="HRworks">HRworks</option>
      <option value="Cegid">Cegid</option>
      <option value="Join">Join</option>
      <option value="Kenjo">Kenjo</option>
      ...
      <option value="Coveto">Coveto</option>
      <option value="HR4You">HR4You</option>
    </select>
  ...
  <div class="table-container">
    <table id="ats-table">
      <thead>
        ...
        <tr>
          <th style="width:150px;">Job Sync</th>
          <th style="width:150px;"><img src="https://onlyfy.com/wp-content/themes/onlyfy/assets/icons/logo.svg" alt="Onlyfy"></th>
          <th style="min-width:150px;"><img class="guidecom-logo" src="https://www.guidecom.de/_assets/407aa76fe6bede19af48e7793075494f/img/logo_guidecom.svg" alt="GuideCom"></th>
          <th style="width:150px;"><svg width="100" height="20" viewBox="0 0 122 24" fill="none" xmlns="http://www.w3.org/2000/svg"><!-- CustomSVG --></svg></th>
          <th style="width:150px;"><img src="https://www.cornerstoneondemand.com/_next/image/?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F43ea2a5t%2Fcsod-new%2Fd81c21c51a9626f632933d779140d4638ae1f744-939x146.svg&w=384&q=75" alt="Cornerstone"></th>
          <th style="width:150px;"><img class="workday-logo" src="https://www.workday.com/content/dam/web/zz/images/logos/workday/workday-logo.svg#icon" alt="Workday"></th>
          <th style="width:150px;"><img src="https://example.com/zvoove-logo.svg" alt="Zvoove"></th>
          <th style="width:150px;"><img src="https://softgarden.com/wp-content/uploads/2023/06/logo_light.png" alt="Softgarden XML">[XML]</th>
          <th style="width:150px;"><img src="https://softgarden.com/wp-content/uploads/2023/06/logo_light.png" alt="Softgarden API">[API]</th>
          <th style="width:150px;"><img src="https://www.umantis.com/wp-content/uploads/2024/11/Abacus_Umantis_Logo_Farbe_Claim_klein.png" alt="Umantis"></th>
          <th style="width:150px;"><img src="https://www.dvinci.de/wp-content/smush-webp/2020/10/brand_dvinci@2x.png.webp" alt="D.vinci"></th>
          <th style="width:150px;"><img src="https://www.b-ite.de/images/logo-8b4a2b5bccdda5af4b02.svg" alt="B-ite"></th>
          <th style="width:150px;"><img src="https://www.hrworks.de/wp-content/uploads/HR_WORKS_LOGO_RGB.svg" alt="HRworks"></th>
          <th style="width:150px;"><img src="https://www.cegid.com/de/wp-content/uploads/sites/8/2023/04/cegid-logo-blue.svg" alt="Cegid"></th>
          <th style="width:150px;"><img class="join-logo" src="https://s3-eu-west-1.amazonaws.com/tpd/logos/60194bf040bb78000169d673/0x0.png" alt="Join"></th>
          <th style="width:150px;"><img src="https://kenjo-company-website.cdn.prismic.io/kenjo-company-website/b0934848-ddd6-4e63-ae91-a3ee3f3a4b5a_kenjo-horizontal-logo.svg?fit=max&w=384" alt="Kenjo"></th>
          <th style="width:180px;"><img class="erecruiter-logo" src="https://www.erecruiter.net/wp-content/uploads/2020/04/Logo-eRecruiter-0219-RZ-Green.png" alt="eRecruiter"></th>
          <th style="width:150px;"><img src="https://www.lever.co/wp-content/uploads/2022/09/Lever_Employ_Logo_Horizontal_Turquoise_Black.png" alt="Lever"></th>
          <th style="width:150px;"><img class="factorial-logo" src="https://upload.wikimedia.org/wikipedia/commons/c/c5/Factorial_company_logo_in_radical_red_color_with_text_saying_Factorial_in_Fira_font_type.png" alt="Factorial"></th>
          <th style="width:150px;"><img src="https://images.teamtailor-cdn.com/images/s3/teamtailor-production/gallery_picture/image_uploads/2da198be-dbf8-4865-9e24-ea6dcaad606b/original.png" alt="TeamTailor"></th>
          <th style="width:150px;"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Greenhouse_logo.png/800px-Greenhouse_logo.png" alt="Greenhouse"></th>
          <th style="width:150px;"><img src="https://hr-path.com/wp-content/uploads/2021/09/SAP_SuccessF_horz_R_pos_blugld.png" alt="Successfactors"></th>
          <th style="width:150px;"><img class="recruitee-logo" src="https://www.one-click-recruiting.de/wp-content/uploads/2023/02/Recruitee-logo.png" alt="Recruitee"></th>
          <th style="width:150px;"><img src="https://www.smartrecruiters.com/wp-content/themes/smartrecruiters/img/2024/SmartRecruiters-Logo.svg" alt="SmartRecruiters"></th>
          <th style="width:200px;"><img class="coveto-logo" src="https://www.personalwirtschaft.de/wp-content/uploads/2022/11/coveto-b-g.png" alt="Coveto"></th>
          <th style="width:150px;"><img class="Hr4you-logo" src="https://www.hr4you.de/wp-content/uploads/2021/08/HR4YOU-neuesLogo_cmyk.png" alt="HR4You"></th>
        </tr>
        <!-- 2. Header-Zeile: ATS Name -->
        <tr>
          <th>ATS Name</th>
  ...
  <script>
    (function() {
      ...
      const nameRow   = table.tHead.rows[1];
      const atsSelect = document.getElementById('ats-select');
      const resetBtn  = document.getElementById('reset-filter');

      function filterTable() {
        const selected = Array.from(atsSelect.selectedOptions)
        ...
        const matchIndices = [];
        Array.from(nameRow.cells).forEach((th, idx) => {
          if (th.dataset.ats && selected.includes(th.dataset.ats.toLowerCase())) {
        ...
        Array.from(table.querySelectorAll('thead tr, tbody tr'))
             .forEach(row => {
               Array.from(row.cells).forEach((cell, idx) => {
                 if (idx === 0 || matchIndices.includes(idx)) {
      ...
      atsSelect.addEventListener('change', filterTable);
      resetBtn.addEventListener('click', () => {
        atsSelect.selectedIndex = -1;
        table.querySelectorAll('.hidden')
             .forEach(c => c.classList.remove('hidden'));
      });
    })();
