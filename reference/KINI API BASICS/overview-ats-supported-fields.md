...
<head>
  ...
  <style>
    ...
    /* verschiedene Logo-Klassen wie gehabt… */
    .guidecom-logo { width: 200px; }
    .workday-logo  { width: 100px; }
    /* … usw. … */
    ...
    #ats-list {
      ...
      overflow-y: auto;
      z-index: 10;
      display: none;   /* versteckt, bis wir Vorschläge füllen */
    }
    #ats-list li {
...
<tr><td>salary_currency</td><td>✅</td><td>❌</td><td>✅</td><td>✅</td><td>❌</td><td>✅</td><td>❌</td><td>❌</td><td>❌</td><td>✅</td><td>❌</td><td>❌</td><td>❌</td><td>✅</td><td>❌</td><td>✅</td><td>✅</td><td>❌</td><td>❌</td><td>✅</td><td>✅</td><td>❌</td><td>❌</td><td>❌</td><td>❌</td></tr>
 ...
 <tr><td>screening_questions</td><td>❌</td><td>✅</td><td>✅</td><td>❌</td><td>❌</td><td>❌</td><td>✅</td><td>✅</td><td>❌</td><td>✅</td><td>❌</td><td>❌</td><td>❌</td><td>✅</td><td>❌</td><td>✅</td><td>❌</td><td>❌</td><td>✅</td><td>✅</td><td>❌</td><td>✅</td><td>❌</td><td>❌</td><td>❌</td></tr>
  ...
  <script>
    (function(){
      const atsOptions = [
        "Onlyfy","GuideCom","CustomSVG","Cornerstone","Workday","Zvoove",
      ...
      function filterTable(){
        ...
        // Wenn nichts eingegeben: alles anzeigen
        if(!query){
        ...
        Array.from(nameRow.cells).forEach((th, idx)=>{
          if(th.dataset.ats &&
             th.dataset.ats.toLowerCase()===query){
            matchIndex = idx;
          }
        });
        // Wenn gefunden: verstecke alle anderen, zeige Erstspalte + gefundene
      ...
      input.addEventListener('keydown', e=>{
        if(e.key==='Enter'){ e.preventDefault(); showSuggestions(); filterTable(); }
      });
      resetBtn.addEventListener('click', ()=>{
