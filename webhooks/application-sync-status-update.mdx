...
Kini does **not** sign webhook payloads — there is no `Kini-Signature` header and no HMAC to verify. To confirm a request came from Kini, validate the header/token you configured. Contact [tech@getkini.com](mailto:tech@getkini.com) if you'd also like to allowlist our egress IPs.
