...
Both endpoints require a partner-scoped API key in the `Authorization` header — see [Authentication](/guides/authentication).
...
- Hand the setup to the company admin instead: [Create Magic Link](/api/post-companies-id-magic) sends them into Kini's own setup UI, and you skip building the form altogether.
