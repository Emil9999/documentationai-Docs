...
>
> Starting 15 January, the Kini API will exclusively support paginated responses for the **GET /jobs** and **GET /applications** endpoints. To prepare for this change, you can enable pagination now by including the parameter `pagination=true` in your requests.
