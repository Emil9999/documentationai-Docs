...
<head>
  ...
  <style>
    ...
    img.guidecom-logo, img.recruitee-logo, img.coveto-logo, img.Hr4you-logo,
    img.rexx-logo, img.factorial-logo, img.erecruiter-logo, img.workday-logo,
    img.join-logo {
      width: auto;
      height: auto;
    }
    ...
    /* DARK MODE SCHUTZ FÜR SVG LOGOS */
    th svg, td svg {
      fill: #111111 !important;
      color: #111111 !important;
    }

    /* OPTIONAL: Nur helles Farbschema erzwingen */
    * {
