...
<body>
    <div class="table-container">
        <table>
            <thead>
                <tr>
                    <th style="width: 150px;">Supported Fields:Job Sync</th>
