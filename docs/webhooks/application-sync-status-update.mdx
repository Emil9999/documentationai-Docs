...
description: "The Status Webhook allows you to receive real-time updates on application statuses. Whenever an application's status changes, a Webhook Payload will be sent to a URL you define."
---
