...
description: "The Status Webhook allows you to receive real-time updates on job booking statuses. Whenever a job booking is booked or published, a Webhook Payload will be sent to a URL you define."
---
...
Every delivery includes a `Kini-Signature` header containing an HMAC-SHA256 signature of the body, computed with the signing secret configured for your company. Verify it on your side before processing. Contact [support@getkini.com](mailto:support@getkini.com) if you need to obtain or rotate your signing secret.
