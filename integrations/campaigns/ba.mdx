...
Kini publishes jobs to the [Jobbörse of the Bundesagentur für Arbeit](https://www.arbeitsagentur.de/jobsuche/) through the BA's official interface. Postings are booked as part of a **campaign** in the Kini App; Kini takes care of the transfer to the BA and keeps the posting status up to date until the job is live.
...
<Steps>
  <Step title="Campaign" icon="flag">
    Set up a campaign in the [Kini App](https://app.getkini.com/) that includes the BA as a channel. Individual jobs can be added to the campaign at any time via the job's **Promote** function ("Add to campaign"). Each job added to the campaign creates a booking, starting in status `BOOKED`.
  </Step>
