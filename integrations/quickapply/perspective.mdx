...
description: >-
  Instructions for configuring Perspective so that candidate applications are
  successfully sent to Kini and then forwarded to your Applicant Tracking System
  (ATS) in real time.
---
...
**Option B: URL parameter utm\_term ✨**
...
##### :question:Not sure where to find your external\_id?

If you're not sure where to find your Job's external\_id, feel free to reach out to us:
📧 [**tech@getkini.com**](mailto:tech@getkini.com)
...
#### [6️⃣](https://emojipedia.org/keycap-digit-six) Ignored Fields

Any Perspective field prefixed with **`ignore_`** will be excluded from the synchronization and not forwarded to the ATS.

---

#### [7️⃣](https://emojipedia.org/keycap-digit-seven) All Other Fields → Comments
...
#### [8️⃣](https://emojipedia.org/keycap-digit-eight) Add Webhook URL
...
- Either embed the **external\_id** in brackets in your result page title **or** add **`utm_term`** as a URL parameter to pass the external job ID.
