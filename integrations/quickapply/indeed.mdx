...
`https://api.getkini.com/webhooks/indeed/{kini_partner_id}/{kini_company_id}/{external_job_id}`

- **Partner ID**: A unique identifier assigned to you, provided by the Kini team.
...
If you have any questions or need help with the integration, feel free to reach out to us: [tech@getkini.com](mailto:tech@getkini.com)
